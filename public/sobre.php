    ...
    <main class="container my-5">
        <div class="row">
            <div class="col-12 text-center mb-5">
                <h1 class="display-4 fw-bold text-danger">A História do La Tavola Fina</h1>
        ...
        <div class="row align-items-center mb-5 pb-4 border-bottom">
            <div class="col-md-6 order-md-1">
                <h2 class="h3 mb-3 text-dark">A Arte da Mesa Refinada</h2>
                <p>
        ...
        <div class="row align-items-center flex-row-reverse mb-5 pb-4">
            <div class="col-md-6 text-center">
                <img src="./assets/imgs/chef.png" class="img-fluid rounded-circle shadow-lg mb-3"
                    style="width: 250px; height: 250px; object-fit: cover;" alt="Chef Marcelo Bianchi">
            </div>
            <div class="col-md-6">
                <h2 class="h3 mb-3 text-dark">Nosso Maestro: Chef Marcelo Bianchi</h2>
                <p>
        ...
        <div class="text-center mt-5 p-4 bg-light rounded shadow-sm">
            ...
            <a href="reserva.php" class="btn btn-danger btn-lg">Faça sua Reserva</a>
        </div>
